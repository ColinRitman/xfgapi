...
inputSpec: /local/api/openapi/fuego-openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{82CD011E-4A29-4D58-9F32-22258469CECC}'
...
## Api Information
- appName: Elderfire API Gateway
- appVersion: 1.0.0
- appDescription: REST API over Fuego Wallet RPC
